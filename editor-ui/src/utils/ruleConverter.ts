/**
 * Configure Compute Rule Converter Utilities
 *
 * Provides validation, compression, and export utilities for CC graphs.
...
export function generateFastlyToml(config: ServiceConfig): string {
  let toml = `# Configure Compute Configuration
# Generated by Configure Compute Editor
